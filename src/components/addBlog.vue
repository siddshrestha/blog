  ...
  <div id="add-blog">
      ...
      <form v-if="!submitted">
          ...
          <div id="checkboxes">
              ...
              <input type="checkbox" value="avengers" v-model="blog.categories"/>
              <label>Super soldiers</label>
...
export default {
  ...
  methods: {
      post: function(){
          this.$http.post('https://vuejsdummyblog-default-rtdb.firebaseio.com/posts.json', this.blog
          ).then(function(data){
              console.log(data);
              this.submitted = "true"
          })
